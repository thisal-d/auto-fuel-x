...
<div class="profile-container">
  ...
  <div class="profile-header">
    ...
    <div class="profile-info">
      ...
      <p><%= empType %> <span class="status-badge <%= isActive ? "status-active" : "status-inactive" %>"><%= employee.getStatus() %></span></p>
  ...
  <div class="profile-dashboard">
    ...
    <div class="profile-main">
      ...
      <div class="profile-section">
        <h2><div class="section-icon">P</div>Personal Information</h2>
        <div class="info-grid">
          <div class="info-item">
            <div class="info-label">Employee ID</div>
            <div class="info-value"><%= employee.getEmployeeID() %></div>
          </div>
          <div class="info-item">
            <div class="info-label">Full Name</div>
            <div class="info-value"><%= employee.getFirstName() %> <%= employee.getLastName() %></div>
          </div>
          <div class="info-item">
            <div class="info-label">Date of Birth</div>
            <div class="info-value"><%= employee.getDateOfBirth() %></div>
          </div>
          <div class="info-item">
            <div class="info-label">Email</div>
            <div class="info-value"><%= employee.getEmail() %></div>
          </div>
        </div>
      ...
      <!-- Employment Details -->
      <div class="profile-section">
        <h2><div class="section-icon">E</div>Employment Details</h2>
        <div class="info-grid">
          <div class="info-item">
          ...
          <div class="info-item">
            ...
            <div class="info-value"><%= employee.getType() %></div>
          </div>
          <div class="info-item">
            <div class="info-label">Status</div>
            <div class="info-value"><%= employee.getStatus() %></div>
          </div>
          <div class="info-item">
            <div class="info-label">Hire Date</div>
            <div class="info-value"><%= employee.getHireDate() %></div>
          </div>
          <div class="info-item">
            <div class="info-label">Salary</div>
            <div class="info-value">Rs. <%= employee.getSalary() %></div>
          </div>
          <div class="info-item">
    ...
    <div class="profile-sidebar">
      <!-- Address -->
      <div class="profile-section">
        <h2><div class="section-icon">A</div>Address</h2>
        <div class="address-card">
          <p><%= employee.getAddressNo() %></p>
          <p><%= employee.getAddressLane() %></p>
          <p><%= employee.getAddressArea() %></p>
        </div>
      </div>

      <!-- Quick Actions -->
      <div class="profile-section">
        <h2><div class="section-icon">Q</div>Quick Actions</h2>
        <div style="display: flex; flex-direction: column; gap: var(--spacing-md);">
          <a href="<%=request.getContextPath()%>/views/employee/edit.jsp" class="btn btn-primary">Edit Profile</a>

...
<%
    ...
    if (selectedVehicleStr != null && !"All".equals(selectedVehicleStr))
        selectedVehicle = Integer.parseInt(selectedVehicleStr);
...
<div class="container">
        ...
        <form method="get" action="<%= request.getContextPath() %>/customer/service-booking/history"
            ...
            <div class="filter-group">
                ...
                <select name="vehicle-type" id="vehicle-type">
                    ...
                    <option value="<%= type %>" <%= type.equals(selectedVehicleType) ? "selected" : "" %>><%= type %>
                    </option>
                    <% } %>
                </select>
            </div>
            ...
            <div class="filter-group">
                ...
                <select name="vehicle" id="vehicle">
                    ...
                    <option value="<%= vehicle.getVehicleID() %>" <%= (vehicle.getVehicleID() == selectedVehicle) ? "selected" : "" %>><%= vehicle.getModel() %>
            ...
            <div class="filter-group">
                ...
                <select name="status" id="status">
                    ...
                    <option value="<%=status %>" <%= status.equals(selectedStatus) ? "selected" : "" %>><%= status %>
                    </option>
                    <% } %>
                </select>
            </div>
            ...
            <div class="filter-group">
                ...
                <input type="number" id="min-cost" name="min-cost" step="0.01"
                       value="<%= selectedMinCost != null ? selectedMinCost : "" %>">
            </div>

            <div class="filter-group">
                <label for="max-cost">Max Cost:</label>
                <input type="number" id="max-cost" name="max-cost" step="0.01"
                       value="<%= selectedMaxCost != null ? selectedMaxCost : "" %>">
            </div>

            <div class="filter-group">
                <label for="keyword">Keyword:</label>
                <input type="text" id="keyword" name="keyword"
                       value="<%= selectedKeyWord != null ? selectedKeyWord : "" %>">
            </div>
    ...
    <div class="table-container">
        <table class="booking-table">
            ...
            <tr>
                <td><%= booking.getBookingDate() + " " + booking.getBookingTime()%>
                </td>
                <td><%= booking.getVehiclePlate() %> - <%= booking.getVehicleModel() %>
                </td>
                <td><%= booking.getServiceType() + " (" + booking.getServiceCost() + ") "%>
                </td>
                <td>
                ...
                <td class="cost-display">Rs. <%= booking.getTotalCost() %>
                </td>
            </tr>
            <% } %>
            </tbody>

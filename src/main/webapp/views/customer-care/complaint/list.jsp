    ...
    <div class="filter-section">
        ...
        <form method="GET" action="<%= request.getContextPath() %>/customer-care/complaint/list" class="filter-form">
            ...
            <div class="filter-group">
                ...
                <input type="date" name="last-update-date"
                       value="<%= lastUpdateDateFilter != null ? lastUpdateDateFilter : "" %>"
                       class="form-control">
            </div>
            ...
            <div class="filter-actions">
                ...
                <a href="<%= request.getContextPath() %>/customer-care/complaint/list"
        ...
        <div class="table-container">
            <table class="complaint-table">
                ...
                <tr>
                    ...
                    <td><%= complaint.getCreatedDate() %>
                    </td>
                    <td><%= complaint.getCreatedTime() %>
                    </td>
                    <td><%= complaint.getUpdatedDate() %>
                    </td>
                    <td><%= complaint.getUpdateTime() %>
                    </td>
                    <td>
                    ...
                    <td><%= (complaint.getRepliedEmployeeName() != null ? complaint.getRepliedEmployeeName() : "N/A")  %>
                    </td>
                </tr>
                <% }
                } %>

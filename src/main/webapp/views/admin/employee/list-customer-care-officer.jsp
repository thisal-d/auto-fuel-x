...
<head>
  <meta charset="UTF-8">
  <title>Customer Care Officer Employees</title>
</head>
<body>
<h1>Customer Care Officer Employees</h1>

<p>
  <a href="<%= request.getContextPath() %>/employees/list">Back to All Employees</a> |
  <a href="<%= request.getContextPath() %>/employees/add-form">Add New Customer Care Officer</a>
</p>

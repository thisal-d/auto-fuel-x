...
<html>
<head>
    <title>Service Center Staff List</title>
...
<div class="employee-container">
    <div class="employee-header">
        <h1 class="employee-title">Service Center Staff List</h1>
    </div>
    ...
    <div class="filter-section">
        ...
        <form action="<%=request.getContextPath()%>/admin/employee/list-by-type" method="get" class="filter-form">
            <input type="hidden" name="type" value="service-center-staff">
                        ...
                        <div class="action-buttons">
                            <form action="<%=request.getContextPath()%>/admin/employee/status/update" method="post"
                                ...
                                <input type="hidden" name="redirect-url"
                                       value="/admin/employee/list-by-type?type=service-center-staff">

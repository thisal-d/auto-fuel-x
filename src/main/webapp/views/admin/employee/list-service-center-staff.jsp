...
<head>
  <meta charset="UTF-8">
  <title>Service Center Staff Employees</title>
</head>
<body>
<h1>Service Center Staff Employees</h1>

<p>
  <a href="<%= request.getContextPath() %>/employees/list">Back to All Employees</a> |
  <a href="<%= request.getContextPath() %>/employees/add-form">Add New Service Center Staff</a>
</p>

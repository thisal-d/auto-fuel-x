...
<div class="container">
  ...
  <div class="status-cards">
    <div class="status-card total">
      ...
      <div class="status-card-count"><%= totalBookings %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=all" class="status-card-action">View All →</a>
    </div>
    ...
    <div class="status-card pending">
      ...
      <div class="status-card-count"><%= pendingApprovalCount %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=awaiting-confirmation" class="status-card-action">Manage →</a>
    </div>
    ...
    <div class="status-card confirmed">
      ...
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=confirmed" class="status-card-action">Manage →</a>
    </div>
    ...
    <div class="status-card reschedule">
      ...
      <div class="status-card-count"><%= rescheduleRequiredCount %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=reschedule-required" class="status-card-action">Manage →</a>
    </div>
    ...
    <div class="status-card progress">
      ...
      <div class="status-card-count"><%= inProgressCount %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=in-progress" class="status-card-action">Manage →</a>
    </div>
    ...
    <div class="status-card pickup">
      ...
      <div class="status-card-count"><%= waitingPickupCount %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=awaiting-pickup" class="status-card-action">Manage →</a>
    </div>
    ...
    <div class="status-card completed">
      ...
      <div class="status-card-count"><%= completedCount %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=completed" class="status-card-action">View →</a>
    </div>
    ...
    <div class="status-card cancelled">
      ...
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=cancelled" class="status-card-action">View →</a>
    </div>
    ...
    <div class="status-card missed">
      ...
      <div class="status-card-count"><%= missedAppointmentCount %></div>
      <a href="<%= request.getContextPath() %>/admin/service-booking/view?status=missed-appointment" class="status-card-action">View →</a>
    </div>
  </div>

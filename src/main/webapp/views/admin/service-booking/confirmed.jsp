...
<table border="1">
  ...
  <tr>
    ...
    <td>
      ...
      <form action="<%= request.getContextPath() %>/admin/service-booking/update-status" method="post" style="display:inline;">
        ...
        <input type="hidden" name="redirect-url" value="/admin/service-booking/view?status=confirmed">
      ...
      <form action="<%= request.getContextPath() %>/admin/service-booking/update-status" method="post" style="display:inline;">
        ...
        <input type="hidden" name="redirect-url" value="/admin/service-booking/view?status=confirmed">
        <button type="submit">Set as Missed Appointment</button>
      </form>
    </td>
  </tr>
  <%
  ...
  %>
  <tr>
    <td colspan="7">No confirmed bookings found.</td>
  </tr>
  <%
    }
  %>

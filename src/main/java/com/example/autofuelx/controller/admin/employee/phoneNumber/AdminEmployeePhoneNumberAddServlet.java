...
@WebServlet("/admin/employee/phone-number/add")
public class AdminEmployeePhoneNumberAddServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        employeePhoneNumberService.addPhoneNumber(employeeID, phoneNumber);

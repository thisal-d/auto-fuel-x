...
@WebServlet("/employee/phone-number/delete")
public class EmployeePhoneNumberDeleteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean success = employeePhoneNumberService.deletePhoneNumber(employeeID, phoneNumber);

...
public class FuelUsageByTypeDTO {
    ...
    public double getAverageCostPerPurchase() { return averageCostPerPurchase; }
    public void setAverageCostPerPurchase(double averageCostPerPurchase) { this.averageCostPerPurchase = averageCostPerPurchase; }
}
...
public class ServiceBookingSummaryDTO {
    ...
    // Getters and Setters
    public int getTotalActiveBookings() { return totalActiveBookings; }
    public void setTotalActiveBookings(int totalActiveBookings) { this.totalActiveBookings = totalActiveBookings; }
    ...
    public int getTotalAwaitingConfirmation() { return totalAwaitingConfirmation; }
    public void setTotalAwaitingConfirmation(int totalAwaitingConfirmation) { this.totalAwaitingConfirmation = totalAwaitingConfirmation; }
    ...
    public int getTotalMissedAppointment() { return totalMissedAppointment; }
    public void setTotalMissedAppointment(int totalMissedAppointment) { this.totalMissedAppointment = totalMissedAppointment; }

    public int getTotalAwaitingPickup() { return totalAwaitingPickup; }
    public void setTotalAwaitingPickup(int totalAwaitingPickup) { this.totalAwaitingPickup = totalAwaitingPickup; }

    public int getTotalRescheduleRequired() { return totalRescheduleRequired; }
    public void setTotalRescheduleRequired(int totalRescheduleRequired) { this.totalRescheduleRequired = totalRescheduleRequired; }
